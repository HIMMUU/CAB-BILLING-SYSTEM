...
let TenantContextService = TenantContextService_1 = class TenantContextService {
    runWithContext(store, callback) {
        return TenantContextService_1.asyncLocalStorage.run(store, callback);
    }
    getStore() {
        return TenantContextService_1.asyncLocalStorage.getStore();
    }
    getTenantId() {
...
TenantContextService.asyncLocalStorage = new async_hooks_1.AsyncLocalStorage();
