...
let AuthService = class AuthService {
    ...
    async register(dto) {
        ...
        if (tenantCount >= 100) {
            throw new common_1.BadRequestException('SaaS instance has reached its limit of 100 tenants.');
        }
    ...
    async login(dto) {
        ...
        if (user.status !== 'ACTIVE') {
            throw new common_1.UnauthorizedException(`User account is ${user.status.toLowerCase()}`);
        }
